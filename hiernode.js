 ...
 */
HierNodeLib.HierNode = function(ThisNode)
{
	...
	if (typeof ThisNode == 'undefined') ThisNode = {};
	...
	ThisNode.CloneNode = function()
	{
		...
		var node = HierNodeLib.CloneObject(this);
		// node = HierNode(node);
	...
	ThisNode.VisitNodes = function(NodeVisitor, VisitationType, IncludeThis)
	{
	 ...
	 */
	ThisNode.VisitPrevious = function(NodeVisitor, IncludeThis)
	{
		if (typeof IncludeThis == 'undefined') IncludeThis = false;
	 ...
	 */
	ThisNode.VisitNext = function(NodeVisitor, IncludeThis)
	{
		if (typeof IncludeThis == 'undefined') IncludeThis = false;
	 ...
	 */
	ThisNode.VisitParents = function(NodeVisitor, IncludeThis)
	{
		if (typeof IncludeThis == 'undefined') IncludeThis = false;
	 ...
	 */
	ThisNode.VisitPreviousSiblings = function(NodeVisitor, IncludeThis)
	{
		if (typeof IncludeThis == 'undefined') IncludeThis = false;
	 ...
	 */
	ThisNode.VisitNextSiblings = function(NodeVisitor, IncludeThis)
	{
		if (typeof IncludeThis == 'undefined') IncludeThis = false;
	 ...
	 */
	ThisNode.VisitChildren = function(NodeVisitor, IncludeThis)
	{
		if (typeof IncludeThis == 'undefined') IncludeThis = false;
	 ...
	 */
	ThisNode.VisitDescendents = function(NodeVisitor, IncludeThis)
	{
		if (typeof IncludeThis == 'undefined') IncludeThis = false;
	 ...
	 * @summary Children
	 */
	ThisNode.Children = function(IncludeThis)
	{
		if (typeof IncludeThis == 'undefined') IncludeThis = false;
	 ...
	 * @memberof HierNodeLib.HierNode
	 * @summary SearchChildren
	 */
	ThisNode.SearchChildren = function(PropertyName, PropertyValue, IncludeThis)
	{
		if (typeof IncludeThis == 'undefined') IncludeThis = false;
	...
	//==========================================
	/** @function SearchFirstChild
	 * @memberof HierNodeLib.HierNode
	 * @summary SearchFirstChild
	 */
	ThisNode.SearchFirstChild = function(PropertyName, PropertyValue, IncludeThis)
	{
		if (typeof IncludeThis == 'undefined') IncludeThis = false;
	...
	//==========================================
	/** @function DescendentCount
	 * @memberof HierNodeLib.HierNode
	 * @summary DescendentCount
	 */
	 ...
	 * @summary Descendents
	 */
	ThisNode.Descendents = function(IncludeThis)
	{
		if (typeof IncludeThis == 'undefined') IncludeThis = false;
	...
	//==========================================
	/** @function SearchDescendents
	 * @memberof HierNodeLib.HierNode
	 * @summary SearchDescendents
	 */
	ThisNode.SearchDescendents = function(PropertyName, PropertyValue, IncludeThis)
	{
		if (typeof IncludeThis == 'undefined') IncludeThis = false;
	...
	//==========================================
	/** @function SearchFirstDescendent
	 * @memberof HierNodeLib.HierNode
	 * @summary SearchFirstDescendent
	 */
	ThisNode.SearchFirstDescendent = function(PropertyName, PropertyValue, IncludeThis)
	{
		if (typeof IncludeThis == 'undefined') IncludeThis = false;
	 ...
	 */
	ThisNode.AddChild = function(ChildNode, ChildIndex)
	{
	 ...
	 */
	ThisNode.TextGraph = function(TextProperty, IncludeThis, IndentText, EolText)
	{
		if (typeof IncludeThis == 'undefined') IncludeThis = false;
	 ...
	 */
	ThisNode.TextPath = function(TextProperty, IncludeRoot, Delimiter)
	{
	 ...
	 */
	ThisNode.FindPath = function(TextPath, TextProperty, IncludeThis, Delimiter)
	{
		if (typeof IncludeThis == 'undefined') IncludeThis = false;
		if (typeof Delimiter == 'undefined') Delimiter = '/';
 ...
 */
HierNodeLib.TextNode = function(ThisText)
{
	...
	node.AddChildText = function(ThisText, ChildIndex)
	{
		if (typeof ThisText == 'undefined') ThisText = '';
 ...
 */
HierNodeLib.CloneObject = function(ThisObject)
{
	...
	if (ThisObject instanceof Array)
	{
		...
		{
			copy[i] = HierNodeLib.CloneObject(ThisObject[i]);
		}
		return copy;
	}
	...
	if (ThisObject instanceof Object)
	{
		...
		{
			if (ThisObject.hasOwnProperty(attr)) copy[attr] = HierNodeLib.CloneObject(ThisObject[attr]);
		}
		return copy;
	}
 ...
 */
HierNodeLib.NullVisitor = function()
{
 ...
 */
HierNodeLib.CountingVisitor = function()
{
	this.Count = 0;
	this.Visit = function(ThisNode)
	{
 ...
 */
HierNodeLib.CollectingVisitor = function(CloneNodes)
{
	if (typeof CloneNodes == 'undefined') CloneNodes = false;
 ...
 */
HierNodeLib.IndexSelectorVisitor = function(Index)
{
	this.Index = Index;
	this.Count = 0;
	this.Node = null;
 ...
 */
HierNodeLib.PropertySearchVisitor = function(PropertyName, PropertyValue, MaxResults)
{
	if (typeof MaxResults == 'undefined') MaxResults = 0;
 ...
 */
HierNodeLib.PropertySearchFirstVisitor = function(PropertyName, PropertyValue)
{
	this.PropertyName = PropertyName;
	this.PropertyValue = PropertyValue;
	this.Node = null;
...
if (typeof window != 'undefined') window['HierNodeLib'] = HierNodeLib;
if (typeof window != 'undefined') window['HierNode'] = HierNodeLib.HierNode;
if (typeof window != 'undefined') window['TextNode'] = HierNodeLib.TextNode;


//==========================================
// Integrate with the nodejs environment.
if (typeof exports != 'undefined') exports.HierNodeLib = HierNodeLib;
if (typeof exports != 'undefined') exports.HierNode = HierNodeLib.HierNode;
if (typeof exports != 'undefined') exports.TextNode = HierNodeLib.TextNode;
